...
<div class="card shadow mb-4">
	...
	<div class="col-md-12">
		...
		<div class="panel-heading">
			<center><h2>View data to Website</h2></center>
		</div>
	    <div class="panel-body form-group">
		    <div class="row">
		    	<div class="input-group" style="margin:5px 0px;">
					...
					<input readonly class="form-control" name="title1" value="<?=$title0?>" type="text" autocomplete="off" >
				</div>	
				<div class="input-group" style="margin:5px 0px;">	
				...
				<div class="input-group" style="margin:5px 0px;">	
					...
					<input readonly class="form-control" name="short1" value="<?=$short0?>">
				</div>
				<div class="input-group" style="margin:5px 0px;">	
